...
abstract class KiloAgent extends Agent implements SupportsGuidelines, SupportsMcp, SupportsSkills
{
    ...
    {
        return $this->configPath("boost.agents.{$this->getConfigKey()}.guidelines_path", 'AGENTS.md');
    }

    public function skillsPath(): string
    {
        return $this->configPath("boost.agents.{$this->getConfigKey()}.skills_path", '.kilocode/skills');
    }
